...
BOOTSTRAP_MODELS: dict[str, dict[str, Any]] = {
    "tornado": {
        ...
        "terms": [
            ...
            term("ehi", 0.32, 3.0),
            term("cinSb", 0.18, transform="inverse_range", min=-200.0, max=-25.0),
            term("cinMl", 0.10, transform="inverse_range", min=-200.0, max=-25.0),
    ...
    "hail": {
        ...
        "terms": [
            ...
            term("scp", 0.18, 6.0),
            term("lapseRate700500CPerKm", 0.42, 2.5, offset=5.5),
            term("freezingLevelM", 0.18, transform="inverse_range", min=1800.0, max=5000.0),
            term("cinMu", 0.18, transform="inverse_range", min=-200.0, max=-25.0),
    ...
    "wind": {
        ...
        "terms": [
            ...
            term("scp", 0.24, 6.0),
            term("pwatIn", 0.22, 1.8),
            term("cinMl", 0.18, transform="inverse_range", min=-200.0, max=-25.0),
